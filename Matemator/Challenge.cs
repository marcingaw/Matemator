...
namespace Matemator {
    ...
    class Challenge {
        ...
        public Challenge(int sumRange, int mulRange) {
            switch (random.Next(0, 4)) {
                case 0:
                    Operator = OP_SUM;
                    Result = random.Next(2, sumRange + 1);
                ...
                case 2:
                    Operator = OP_MUL;
                    Result = random.Next((int)Math.Sqrt(mulRange), mulRange + 1);
                ...
                case 3:
                    Operator = OP_DIV;
                    Left = random.Next((int)Math.Sqrt(mulRange), mulRange + 1);
